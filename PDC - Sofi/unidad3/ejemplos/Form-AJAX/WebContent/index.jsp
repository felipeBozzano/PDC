...
<body>
	...
	<div id="main">
	    ...
	    <form id="form" action="javascript:void(null)" method="post" class="col-md-12 order-md-1" onsubmit="jForm.valid(event)">
	       <div class="row">
	        ...
	        <div class="row">
				...
				<div class="col-md-3 iotranac">
					...
					<input type="text" id="iotranac" name="otra_nacionalidad" class="form-control" maxlength="255" size="40" disabled="disabled" required/>
				</div>
			</div>
	        <div class="row">
	         	<div class="col-md-6 mb-3">
